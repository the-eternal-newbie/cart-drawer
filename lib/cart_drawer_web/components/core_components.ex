defmodule CartDrawerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(CartDrawerWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(CartDrawerWeb.Gettext, "errors", msg, opts)
    # end
